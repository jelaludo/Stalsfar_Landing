...
Fleet re-entry uses opposing, seeded lateral approaches with sweeping course corrections and crossing screen paths. The camera holds a wide view for the first eleven seconds; plasma wakes persist through the crossing pass. Automatic vehicles straighten over their assigned pads before final approach. This presentation change preserves the seeded schedules and reliability outcomes.
